...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { location: @widget.location, params: @widget.params, size: @widget.size, widgettype: @widget.widgettype }
    end
  ...
  test "should update widget" do
    put :update, id: @widget, widget: { location: @widget.location, params: @widget.params, size: @widget.size, widgettype: @widget.widgettype }
    assert_redirected_to widget_path(assigns(:widget))
  end
